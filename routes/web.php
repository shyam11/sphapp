...
Route::get('/patientedit/{id}','HomeController@edit');
Route::post('/updatepatient', ['as' => 'updatepatient', 'uses' => 'HomeController@updatePatient'])->middleware('auth');
Route::post('/filteradmin',['as' => 'filteradmin', 'uses' => 'HomeController@filterAdmin'])->middleware('auth','doctor');
